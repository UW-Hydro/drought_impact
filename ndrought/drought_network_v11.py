...
class EventNode():
    ...
    def __init__(self, time, area, coords, id):
        ...
        self.group_id = id
        # want to be able to easily identify threads
        self.thread_id = -1
        self.consumed_threads = list()
                    ...
                    for node in nodes_i:
                        ...
                        for last_node in last_nodes:
                            ...
                            if check:                
                                ...
                                if node.thread_id != -1 and node.thread_id != last_node.thread_id:
                                    node.consumed_threads.append(node.thread_id)
                                node.thread_id = last_node.thread_id
