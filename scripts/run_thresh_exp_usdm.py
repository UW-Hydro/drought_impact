...
if __name__ == "__main__":
    ...
    area_thresh = [3000, 2800, 1400]
    ratio_thresh = [0.6, 0.8, 1.0]
    ...
    for a_thresh in area_thresh:
        for r_thresh in ratio_thresh:
            ...
            config = f'{thresh_exp_dir}/usdm/config/config_{key}.yml'

            if not os.path.exists(f'{thresh_exp_dir}/usdm/track/track_{key}.pickle'):
